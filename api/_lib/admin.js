...
function sessionSecret(){
  // Em produção a sessão usa um secret dedicado quando disponível.
  // Como fallback seguro, usa a service role que já existe apenas no servidor.
  // Nunca deriva a sessão da senha do painel.
